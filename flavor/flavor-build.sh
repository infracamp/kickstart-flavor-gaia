...
apt-get update
apt-get -y install gettext apache2 libapache2-mod-php7.4 composer php-imagick php7.4-curl php7.4-dom php-redis php-xml php-xdebug \
                    php-zip php7.4-mbstring php-ssh2 php-yaml php-xml php-json php-gd \
                    php7.4-intl \
